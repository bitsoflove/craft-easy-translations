...
class Translation extends Element
{
  ...
  {
    return [
      'title' => ['label' => Craft::t('easy-translations', 'Source')],
  ...
  public static function indexHtml(ElementQueryInterface $elementQuery, array $disabledElementIds = null, array $viewState, string $sourceKey = null, string $context = null, bool $includeContainer, bool $showCheckboxes): string
  {
    ...
    Craft::$app->view->registerJs("$('table.fullwidth thead th').css('width', '50%'); $('.checkbox-cell').remove(); $('table tbody tr:not(:last-child) td').css('border-bottom', '1px solid rgba(96,125,159,.1)'); $('table tbody tr:not(:last-child) th').css('border-bottom', '1px solid rgba(96,125,159,.1)');");
